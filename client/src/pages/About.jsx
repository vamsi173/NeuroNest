...
const About = () => {
  return (
    <div className='py-20 max-w-6xl mx-auto'>
      <h1 className='text-3xl font-bold mb-4 text-slate-800'>About N<span className='text-orange-600'>euroNest</span></h1>
      <p  className='mb-4 text-slate-700'  >
      NeuroNest is a leading real estate agency that specializes 
